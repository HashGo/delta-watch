...
(function() {
  ...
  ModWatch = (function() {
    ...
    ModWatch.prototype.watch = function(target, recursive, handler) {
      var changeHanlder, path, traverseFileSystem, watched, _watch;
      ...
      traverseFileSystem = function(files, currentPath, recursive) {
        ...
        if (recursive === true && stats.isDirectory() && files.join('=').indexOf("" + current + "=") < 0) {
          ...
          for (_i = 0, _len = currFiles.length; _i < _len; _i++) {
            ...
            _results.push((function(file) {
              ...
              return traverseFileSystem(files, currentFile, recursive);
            })(file));
          }
          return _results;
        }
